...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $insertmyCases->insertCase($case_number, $filing_number, $party_name, $case_status, $case_next_date, $special_note, $total_amount, $received_amount, $pending_amount, $payment_mode);
}
?>